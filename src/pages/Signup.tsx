...
export default function Signup() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    setBusy(true)
    try {
      // Save draft so we can upsert after email confirmation/login
      saveDraft({
      ...
      if (!data.session) {
        nav('/login', { state: { notice: 'Check your email to confirm your account, then log in.' } })
        return
      }

      // If confirmations are disabled and we DO have a session, upsert now
