...
export const DEFAULT_COVER_URL =
  WIN.DEFAULT_COVER_URL || (VITE.VITE_DEFAULT_COVER_URL as string) || "/brand/taedal-logo.svg";

export const DEFAULT_AVATAR_URL =
  WIN.DEFAULT_AVATAR_URL || (VITE.VITE_DEFAULT_AVATAR_URL as string) || "/brand/taedal-logo.svg";

export const CHAIN_ID =
  toNum(WIN.CHAIN_ID) ?? toNum(VITE.VITE_CHAIN_ID) ?? toNum(CRA.REACT_APP_CHAIN_ID) ?? 11155111;
