...
export default function UserCard({ id, username, display_name, avatar_url, subtitle }: Props) {
  return (
    <Link
    ...
    >
      ...
      <div className="min-w-0">
        <div className="truncate text-sm">{display_name || (username ? `@${username}` : "User")}</div>
